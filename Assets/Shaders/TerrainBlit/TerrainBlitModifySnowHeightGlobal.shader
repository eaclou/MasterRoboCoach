Shader "TerrainBlit/TerrainBlitModifySnowHeightGlobal"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			{	
				...
				float newSnowHeight = newHeight.x * mask1Value.x * mask2Value.x;
				...
				//float amountToAdd = max(0, baseHeight.x + baseHeight.y - snowLine); 
				
				// Operation:
				// Addition:
				baseHeight.z += snowMask;
