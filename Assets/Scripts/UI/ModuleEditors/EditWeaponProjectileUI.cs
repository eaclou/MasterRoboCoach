...
public class EditWeaponProjectileUI : MonoBehaviour {

    public WeaponProjectileGenome genome;
    ...
    public void SetStatusFromData() {
        textModuleDescription.text = "Weapon (Projectile) " + genome.inno.ToString();
